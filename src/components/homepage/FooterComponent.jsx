      ...
      <div className="py-6 space-y-5">
        <div className="min-h-[50vh] grid lg:grid-cols-2">
          <div className="flex flex-col gap-3 w-full justify-center">
            ...
            <p className="text-grey text-sm lg:text-lg leading-relaxed">
          ...
          <div className="w-full flex flex-col gap-3 justify-center md:items-end">
            <p className="text-lg font-semibold">
              Tetap{" "}
              <span className="decoration-orange underline ">Terhubung</span>
            </p>
            ...
            <div className="flex items-center gap-5">
              <Link href={`${instagramUrl}`} target="_blank">
                <div className="p-2 bg-white shadow-sm hover:bg-orange/20 rounded-full text-orange duration-150">
                  <InstagramIcon />
                </div>
              </Link>
        ...
        <div className="text-grey text-xs uppercase text-center">
          copyright &copy; {currentYear} by{" "}
          <Link
            className="underline-offset-2 underline decoration-orange"
